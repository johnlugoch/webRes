                    ...
                    <form role="form">
                        <div class="col-xs-12">
                             <div class="form-group col-lg-6">
                                <label>Introduzca el tipo de paciente</label>
                                <select name="tipo" class="form-control">
                                    <option value="">Seleccione</option>  
                                    <option value="1">Recien Nacido</option>
                                    <option value="2">Niños de 0 a 5 años</option>
                                    <option value="3">Niños de 6 a 11 años</option>
                                    <option value="4">Niños de 12 a 17 años</option>
                                    <option value="5">Mujeres gestantes</option>
                                    <option value="6">Atenciones del parto</option>
                                </select>
                            </div>        
                        ...
                        <div class="js-apply-validate" role="tabpanel">-->
                          ...
                          <div class="table-responsive">
                            <table id="tbl" class="table table-striped">
                                            <!--Aquí añadiremos los objetos parseados del JSON -->
                                    <tbody>
                                    </tbody>
                                </table>
                          </div>
