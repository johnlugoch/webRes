...
<body onload="getInfoNinos05(<?=$_GET['id']?>)">
                        ...
                        <div class="js-apply-validate" role="tabpanel">
                          ...
                          <ul class="nav nav-tabs" role="tablist">
                            <li role="presentation" class="active">
                                <a href="#general" aria-controls="general" role="tab" data-toggle="tab">Niños de 0 a 5 Años</a>
                            </li>                            
                                ...
                                <div class="row">
                                    <!--<form  action="guardar.php" method="POST">-->
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="form-group col-lg-6">
                                                <label>Fecha de Suministro Vitamina A</label>
                                                <input type="date" id="fechaVitamina" name="fechaVitamina" class="form-control" placeholder="" >
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="form-group col-lg-6">
                                                <label>Fecha de Micronutrientes en polvo</label>
                                                <input type="date" id="fechaMicro" name="fechaMicro" class="form-control" placeholder="" >
                                            </div>
                                            <div class="form-group col-lg-6">
                                        ...
                                        <div class="col-lg-12">
                                             <div class="form-group col-lg-6">
                                                ...
                                                <input name="hemo" class="form-control js-vfield js-vstring" placeholder="resultado">
                                            </div>                                         
                                        </div>
        ...
        $(document).ready(function(){            
            ...
            $("#save").click(function(){
              ...
              //if(FNLOGIC.fnsubmit(false)){
                guardarNinosDe05('updateninos05');
              //}else{
                /* ERROR */
              //};
            });
