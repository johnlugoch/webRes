...
<body onload="getInfoNinos1217(<?=$_GET['id']?>)">
                        ...
                        <div class="js-apply-validate" role="tabpanel">
                          ...
                          <ul class="nav nav-tabs" role="tablist">
                            <li role="presentation" class="active">
                                <a href="#general" aria-controls="general" role="tab" data-toggle="tab">Niños de 12 a 17 Años</a>
                            </li>                            
        ...
        $(document).ready(function(){            
            ...
            $("#save").click(function(){
              ...
              //if(FNLOGIC.fnsubmit(false)){
                guardarNinosDe1217('updateninos1217');
              //}else{
                /* ERROR */
              //};
            });
